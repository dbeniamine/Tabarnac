...
* In case of troubles, removing any of the files
  `expname.acc.csv`,`expname.structsStats.csv`,`expname.structsModified.csv`
  will force tabarnac to parse the original trace file again.
