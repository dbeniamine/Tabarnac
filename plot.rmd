...
p <- p + theme_update(axis.text.x=element_text(size=20),axis.text.y=element_text(size=20))
p <- p + theme_update(axis.title=element_text(size=20), title=element_text(size=20))
...
p <- p + theme(strip.text.y = element_text(size=20, face="bold"))
if(titles)
{
...
```{r Distribution, echo=F, fig.height=18, fig.width=20}
